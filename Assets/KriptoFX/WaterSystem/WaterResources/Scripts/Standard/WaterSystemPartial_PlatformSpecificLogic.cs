...
namespace KWS
{
    public partial class WaterSystem
    {
        ...
        { 
            ...
            new ThirdPartyAssetDescription(){EditorName = "Enviro 3 (not yet fully supported)", AssetNameSearchPattern = "Enviro 3 - Sky and Weather", ShaderDefine = "ENVIRO_3_FOG", ShaderInclude = "FogInclude.cginc"},
