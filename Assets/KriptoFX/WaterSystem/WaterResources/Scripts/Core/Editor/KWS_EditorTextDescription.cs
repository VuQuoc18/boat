...
namespace KWS
{
    public class KWS_EditorTextDescription
    {
        ...
        {
            public static readonly string UseScreenSpaceReflection = "Screen space reflection: the fastest method of rendering reflections in real time(it's faster then other SSR methods), use it if possible. " +
                                                                     "It's also the only way to render the correct fog";

            public static readonly string UsePlanarReflection = "Planar reflection use additional camera that draws the selected layers. For example, you can use SSR reflection + planar reflection for important layers (for example a character). " +
                                                                "Don't use all layers, it's very expensive because it render a scene twice!";
            public static readonly string PlanarCullingMask = "Best practice is to render only the important objects (layers), since the rendering of all layers is very expensive, because it render a scene twice!";
        ...
        public static class Refraction
        {
            ...
            public static readonly string RefractionAproximatedDepth = "The approximation uses the average water depth in meters, so greater depth value -> higher distortion and refraction.";
            ...
            public static readonly string RefractionDispersionStrength = "Higher value -> more noticeable the rainbow effect on the edges of objects";
        }
        ...
        public static class Flowing
        {
            ...
            public static readonly string FlowMapBrushStrength = "Higher value -> faster flow speed that you draw";
        ...
        public static class DynamicWaves
        {
            ...
            public static readonly string DynamicWavesRainStrength = "Higher value-> more raindrops";
        }
        ...
        public static class Shoreline
        {
            ...
            public static readonly string ShorelineEditorUsage = "Use Insert/Delete buttons for Add/Delete waves at the current mouse position.";
        ...
        public static class Underwater
        {
            ...
            public static readonly string UnderwaterBlurRadius = "The strength of the blur. Higher value -> slower performance";
        }
