...
namespace KWS
{
    ...
    public class KW_Buoyancy : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            if (OvverideCenterOfMass) _rigidBody.centerOfMass = transform.InverseTransformPoint(OvverideCenterOfMass.transform.position);
        ...
        private void FixedUpdate()
        {
            ...
            for (int i = 0; i < voxels.Count; i++)
            {
                ...
                var waterSurfaceData = WaterSystem.GetWaterSurfaceData(wp);
                ...
                if (waterSurfaceData.IsActualDataReady)
                {
                    ...
                    force.x += surfaceNormal.x * NormalForce * _rigidBody.mass;
                    force.z += surfaceNormal.z * NormalForce * _rigidBody.mass;
